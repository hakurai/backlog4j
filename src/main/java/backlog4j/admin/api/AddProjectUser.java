...
public class AddProjectUser implements BacklogAdminCommand<List<ProjectUser>> {
    ...
    public AddProjectUser(BacklogAdminClient client) {
        this.client = client;
    }

    public AddProjectUser setProjectId(Integer projectId) {
    ...
    public AddProjectUser setUserId(Integer userId) {
    ...
    public List<ProjectUser> execute() {
        ...
        checkParameters();
        Object res = client.execute(BACKLOG_ADMIN_ADD_PROJECT_USER, map);
